...
import App from './pages/App';
  ...
  function setConfig() {  
    ...
    config.set({ path: 'https://ezhressapi.azurewebsites.net', apiPath: 'http://localhost:7072', imagePath: 'https://ezcontentapi.azurewebsites.net', code: 'JRXXeaXTE5Y9WD2kVAYLu6gXknrmLlluqfTJZfo3pZfo4kkBUzf3Yw==', omdb: '8ae68ed6'}, {freeze: false, environment: 'hybrid2'});
