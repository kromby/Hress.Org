    ...
    <div>
      <Post
        ...
        body={
          <section>
            <p>
              Veldu þá mynd sem þig langar til að sjá á uppgjörskvöldinu í
              janúar, smelltu síðan á <b>Kjósa</b> neðst á síðunni til að halda
              áfram
            </p>
          </section>
        }
            ...
            <Post
              ...
              actions={
                <ul className="actions">
                  <div
                    key={hardhead.id}
                    onClick={() => handleChange(hardhead.id)}
                  >
                    <input
                      type="radio"
                      radioGroup={"id_radio"}
                      checked={hardhead.id === value}
                      onChange={() => handleChange(hardhead.id)}
                    />
